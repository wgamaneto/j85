    ...
    <div className="px-4 lg:px-10 sticky top-4 z-50">
      <div className="container mx-auto">
        ...
        >
          ...
          {open && (
            <div className="lg:hidden absolute top-16 left-0 w-full bg-white shadow-lg p-4 z-0 border-t border-gray-200">
              <ul className="flex flex-col items-center gap-4">
                <Button href="#" onClick={() => scrollToTop()}>
                  Inicio
                </Button>
                <Button href="#" onClick={() => scrollToElement("servicos")}>
                  Servicos
                </Button>
                <Button href="#" onClick={() => scrollToElement("feedback")}>
                  Clientes
                </Button>
                <Button href="#" onClick={() => scrollToBottom()}>
                  Localização
                </Button>
