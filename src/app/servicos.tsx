...
const CardSection = ({ isImageFirst, imageSrc, title, description }) => (
  <CardBody className="col-span-full gap-1 place-items-center overflow-visible grid grid-cols-1 lg:grid-cols-4">
    {isImageFirst && (
      <div className="h-[400px] xl:w-[600px] flex items-center overflow-hidden rounded-xl justify-right col-span-2">
        <Image
          width={300}
          height={300}
          src={imageSrc}
    ...
    {!isImageFirst && (
      <div className="h-[400px] xl:w-[600px] flex items-center overflow-hidden rounded-xl justify-center col-span-2">
        <Image
          width={300}
          height={300}
          src={imageSrc}
